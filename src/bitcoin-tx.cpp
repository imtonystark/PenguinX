...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s penguinx-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  penguinx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded penguinx transaction") + "\n" +
              "  penguinx-tx [options] -create [commands]   " + _("Create hex-encoded penguinx transaction") + "\n" +
              "\n";
