...
{
    const char* pszTimestamp = "PenguinX Begins Here.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1516547533, 235956, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0ab1c912aa8570202600f97c07d7b5e386d9a84b4f1caa7df3bfd050bd6ccc96"));
        assert(genesis.hashMerkleRoot == uint256S("a45712f45d1bd5fd507317a36917bc6e7bd5b3053b370ea323f28793a729ab69"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1516555246, 532806, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("a5d2a5724799dbd64c65307299fd1e210bb2041dfa239484a27251b7ad814492"));
        assert(genesis.hashMerkleRoot == uint256S("a45712f45d1bd5fd507317a36917bc6e7bd5b3053b370ea323f28793a729ab69"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // temporarily disabled - J.B. 1/21/2018
