...
const char * const BITCOIN_CONF_FILENAME = "penguinx.conf";
const char * const BITCOIN_PID_FILENAME = "penguinx.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PenguinX";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/PenguinX";
#else
    // Unix
    return pathRet / ".penguinx";
#endif
#endif
}
