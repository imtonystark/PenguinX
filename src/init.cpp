...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/penguinx-project/penguinx>";
    const std::string URL_WEBSITE = "<https://penguinx.org>";
