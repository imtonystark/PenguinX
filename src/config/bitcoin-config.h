...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The PenguinX Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "PenguinX Core"
...
#define PACKAGE_BUGREPORT "https://github.com/penguinx-project/penguinx/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PenguinX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PenguinX Core 0.15.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "penguinx"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://penguinx.org/"
