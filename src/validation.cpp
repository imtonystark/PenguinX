...
#if defined(NDEBUG)
# error "PenguinX cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "PenguinX Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PNGX additional fees, %d delta bytes\n",
